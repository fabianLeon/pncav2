...
switch ($task) {
    ...
    case 'list':
        ...
        $dtr = new CHtmlDataTableAlignable();
    ...
    case'add':
        ...
        $form->addInputText('text', 'txt_numero_encuestas', 'txt_numero_encuestas', 20, 1000, $numero_encuestas, '', 'onChange="ocultarDiv(\'error_numero_encuestas\');" autofocus required');
        ...
        //Botones Formulario
        $form->addInputButton('submit', 'btn_add', 'btn_add', BTN_AGREGAR, 'button', 'onClick=validar_add_planeacion();');
